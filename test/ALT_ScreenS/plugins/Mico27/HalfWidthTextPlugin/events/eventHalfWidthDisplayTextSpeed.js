const id = "EVENT_HWT_DISPLAY_TEXT_SPEED";
const name = "Half-Width Text: Draw At Text Speed";
const groups = ["EVENT_GROUP_DIALOGUE"];
const autoLabel = (fetchArg) => {
  return `Half-Width Text: Draw At Text Speed`;
};
...
const compile = (input, helpers) => {
  ...
  _addComment("Half-Width Text: Draw At Text Speed");
  ...
  inputTexts.forEach((inputText) => {
    ...
    _callNative("hwt_display_text_speed");
  });
