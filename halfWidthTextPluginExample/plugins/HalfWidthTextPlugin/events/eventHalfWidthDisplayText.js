const id = "EVENT_HWT_DISPLAY_TEXT_BKG";
const name = "Half-Width Text: Draw To Background";
const groups = ["EVENT_GROUP_DIALOGUE"];
const autoLabel = (fetchArg) => {
  return `Half-Width Text: Draw To Background`;
};
...
const compile = (input, helpers) => {
  ...
  _addComment("Half-Width Text: Draw To Background");
